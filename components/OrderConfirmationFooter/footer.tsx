    ...
    <View className="absolute bottom-0 flex h-44 w-full rounded-3xl bg-white shadow shadow-black">
      ...
      <View className="flex-row">
        <Text className="w-5/6 pl-16 text-center text-xs">
          ...
          the idea of students having to buy brand new books and it’s only good
          for a semester and the founders were like “HEY! Isn’t this like a
          waste of money?” and so UniHub was born. It was born to help students
          find a way to get books affordably.
        </Text>
